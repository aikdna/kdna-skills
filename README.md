...
**KDNA shapes judgment, not tool permission.** KDNA does not override system or safety policy. Unsigned, yanked, or high-risk domains are not silently trusted. See [KDNA Governance](https://github.com/knowledge-dna/KDNA/blob/main/docs/GOVERNANCE.md).
