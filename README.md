...
| **Download from registry** | Fetches [registry/domains.json](https://github.com/aikdna/KDNA/blob/main/registry/domains.json), clones the domain repo, copies to your KDNA directory |
